...
from itt.modeling_itt_cross_ablation_design import IttCrossSequenceClassifier  # /mnt/research/CGA001/MOF_project/code_folder_large/ITTransformer/main/itt/modeling_itt_cross_ablation_design.py
...
def parse_args():
    ...
    # Model ablation
    parser.add_argument('--ablation',  choices=[None, 'PIH', 'Atomic'], default=None,
                      help='Used for ablation study, PIH means PIH will be all zeros, and Atomic means graph related part will be zeros')
...
def train(train_loader, model, criterion, optimizer, scheduler, device, args):
    ...
    for i, batch in enumerate(train_loader):
        ...
        optimizer.zero_grad()
        outputs = model(input_part0=part0, input_part1=part1, input_part2=part2, graph_data=graph_data, use_cross_attention_mask=args.use_cross_attention_mask, ablation=args.ablation)
    ...
    with torch.no_grad():
        for batch in val_loader:
            ...
            outputs = model(input_part0=part0, input_part1=part1, input_part2=part2, 
                          graph_data=graph_data, use_cross_attention_mask=args.use_cross_attention_mask, ablation=args.ablation)
            predictions = outputs[0]
